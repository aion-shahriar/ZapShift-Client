...
const SendParcel = () => {
    ...
    const handleParcel = (data) => {
        ...
        Swal.fire({
                    ...
                    text: `The total cost will be ${cost} BDT`,
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(res => {
                            console.log('after saving data to mongoDB', res.data);
    ...
    return (
        <div>
            <h2 className="text-5xl font-bold mt-6">Send a Parcel</h2>
            <form onSubmit={handleSubmit(handleParcel)} className="space-y-6 mt-12 text-black">
                {/* Document type */}
                <div>
